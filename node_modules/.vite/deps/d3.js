...
function cumsum(values, valueof) {
  var sum4 = 0, index4 = 0;
  return Float64Array.from(values, valueof === void 0 ? (v) => sum4 += +v || 0 : (v) => sum4 += +valueof(v, index4++, values) || 0);
}
...
function fcumsum(values, valueof) {
  ...
  return Float64Array.from(
    values,
    valueof === void 0 ? (v) => adder.add(+v || 0) : (v) => adder.add(+valueof(v, ++index4, values) || 0)
  );
}
...
function circleRadius(cosRadius, point6) {
  ...
  return ((-point6[2] < 0 ? -radius : radius) + tau3 - epsilon2) % tau3;
}
...
function pointEqual_default(a4, b) {
  return abs3(a4[0] - b[0]) < epsilon2 && abs3(a4[1] - b[1]) < epsilon2;
}
...
function longitude(point6) {
  return abs3(point6[0]) <= pi3 ? point6[0] : sign(point6[0]) * ((abs3(point6[0]) + pi3) % tau3 - pi3);
}
function polygonContains_default(polygon, point6) {
  ...
  return (angle2 < -epsilon2 || angle2 < epsilon2 && sum4 < -epsilon22) ^ winding & 1;
}
...
function compareIntersection(a4, b) {
  return ((a4 = a4.x)[0] < 0 ? a4[1] - halfPi3 - epsilon2 : halfPi3 - a4[1]) - ((b = b.x)[0] < 0 ? b[1] - halfPi3 - epsilon2 : halfPi3 - b[1]);
}
  ...
  return {
    ...
    point: function(lambda12, phi12) {
      ...
      if (abs3(delta - pi3) < epsilon2) {
        ...
        if (abs3(lambda04 - sign0) < epsilon2)
          lambda04 -= sign0 * epsilon2;
        if (abs3(lambda12 - sign1) < epsilon2)
          lambda12 -= sign1 * epsilon2;
...
function clipAntimeridianIntersect(lambda04, phi02, lambda12, phi12) {
  ...
  return abs3(sinLambda0Lambda1) > epsilon2 ? atan((sin2(phi02) * (cosPhi1 = cos2(phi12)) * sin2(lambda12) - sin2(phi12) * (cosPhi03 = cos2(phi02)) * sin2(lambda04)) / (cosPhi03 * cosPhi1 * sinLambda0Lambda1)) : (phi02 + phi12) / 2;
}
function clipAntimeridianInterpolate(from, to, direction, stream) {
  ...
  if (from == null) {
    ...
    stream.point(-pi3, 0);
    stream.point(-pi3, phi2);
  } else if (abs3(from[0] - to[0]) > epsilon2) {
...
function circle_default2(radius) {
  var cr = cos2(radius), delta = 2 * radians2, smallRadius = cr > 0, notHemisphere = abs3(cr) > epsilon2;
  ...
  function intersect2(a4, b, two) {
    ...
    var delta2 = lambda12 - lambda04, polar = abs3(delta2 - pi3) < epsilon2, meridian = polar || delta2 < epsilon2;
    if (!polar && phi12 < phi02)
      z = phi02, phi02 = phi12, phi12 = z;
    if (meridian ? polar ? phi02 + phi12 > 0 ^ q[1] < (abs3(q[0] - lambda04) < epsilon2 ? phi02 : phi12) : phi02 <= q[1] && q[1] <= phi12 : delta2 > pi3 ^ (lambda04 <= q[0] && q[0] <= lambda12)) {
...
function clipRectangle(x06, y06, x12, y12) {
  ...
  function corner(p, direction) {
    return abs3(p[0] - x06) < epsilon2 ? direction > 0 ? 0 : 3 : abs3(p[0] - x12) < epsilon2 ? direction > 0 ? 2 : 1 : abs3(p[1] - y06) < epsilon2 ? direction > 0 ? 1 : 0 : direction > 0 ? 3 : 2;
  }
...
function graticuleX(y06, y12, dy) {
  var y4 = range_default(y06, y12 - epsilon2, dy).concat(y12);
  return function(x4) {
...
function graticuleY(x06, x12, dx) {
  var x4 = range_default(x06, x12 - epsilon2, dx).concat(x12);
  return function(y4) {
...
function resample(project, delta2) {
  function resampleLineTo(x06, y06, lambda04, a0, b02, c0, x12, y12, lambda12, a1, b12, c1, depth, stream) {
    ...
    if (d2 > 4 * delta2 && depth--) {
      var a4 = a0 + a1, b = b02 + b12, c6 = c0 + c1, m3 = sqrt(a4 * a4 + b * b + c6 * c6), phi2 = asin(c6 /= m3), lambda22 = abs3(abs3(c6) - 1) < epsilon2 || abs3(lambda04 - lambda12) < epsilon2 ? (lambda04 + lambda12) / 2 : atan2(b, a4), p = project(lambda22, phi2), x22 = p[0], y22 = p[1], dx2 = x22 - x06, dy2 = y22 - y06, dz = dy * dx2 - dx * dy2;
...
function albersUsa_default() {
  ...
  albersUsa.translate = function(_) {
    ...
    alaskaPoint = alaska.translate([x4 - 0.307 * k2, y4 + 0.201 * k2]).clipExtent([[x4 - 0.425 * k2 + epsilon2, y4 + 0.12 * k2 + epsilon2], [x4 - 0.214 * k2 - epsilon2, y4 + 0.234 * k2 - epsilon2]]).stream(pointStream);
    hawaiiPoint = hawaii.translate([x4 - 0.205 * k2, y4 + 0.212 * k2]).clipExtent([[x4 - 0.214 * k2 + epsilon2, y4 + 0.166 * k2 + epsilon2], [x4 - 0.115 * k2 - epsilon2, y4 + 0.234 * k2 - epsilon2]]).stream(pointStream);
    return reset();
  };
...
function mercatorProjection(project) {
  ...
  function reclip() {
    var k2 = pi3 * scale(), t = m3(rotation_default(m3.rotate()).invert([0, 0]));
...
function identity_default3() {
  ...
  projection2.angle = function(_) {
    return arguments.length ? (alpha = _ % 360 * radians2, sa = sin2(alpha), ca = cos2(alpha), reset()) : alpha * degrees2;
  };
  projection2.reflectX = function(_) {
...
var Path = class {
  ...
  arc(x4, y4, r, a0, a1, ccw) {
    ...
    if (da > tauEpsilon) {
      ...
      this._append`A${r},${r},0,${+(da >= pi4)},${cw},${this._x1 = x4 + r * Math.cos(a1)},${this._y1 = y4 + r * Math.sin(a1)}`;
    }
  }
  rect(x4, y4, w, h) {
...
function identity5(domain) {
  ...
  scale.domain = scale.range = function(_) {
    return arguments.length ? (domain = Array.from(_, number4), scale) : domain.slice();
  };
  scale.unknown = function(_) {
    return arguments.length ? (unknown = _, scale) : unknown;
  };
...
function loggish(transform2) {
  ...
  scale.tickFormat = (count4, specifier) => {
    ...
    if (count4 === Infinity)
      return specifier;
    const k2 = Math.max(1, base * count4 / scale.ticks().length);
    return (d) => {
...
function radial() {
  ...
  scale.range = function(_) {
    return arguments.length ? (squared.range((range5 = Array.from(_, number4)).map(square)), scale) : range5.slice();
  };
  scale.rangeRound = function(_) {
...
function calendar(ticks3, tickInterval, year, month, week, day, hour, minute, second2, format2) {
  ...
  scale.nice = function(interval2) {
    ...
    return interval2 ? domain(nice3(d, interval2)) : scale;
  };
  scale.copy = function() {
...
function transformer3() {
  ...
  scale.range = range5(value_default2);
  scale.rangeRound = range5(round_default2);
  scale.unknown = function(_) {
    return arguments.length ? (unknown = _, scale) : unknown;
  };
  return function(t) {
...
function arc_default() {
  ...
  function arc() {
    ...
    if (!(r1 > epsilon4))
      ...
      var a01 = a0, a11 = a1, a00 = a0, a10 = a1, da0 = da, da1 = da, ap = padAngle.apply(this, arguments) / 2, rp = ap > epsilon4 && (padRadius ? +padRadius.apply(this, arguments) : sqrt3(r0 * r0 + r1 * r1)), rc = min4(abs4(r1 - r0) / 2, +cornerRadius.apply(this, arguments)), rc0 = rc, rc1 = rc, t03, t13;
      if (rp > epsilon4) {
...
function pie_default() {
  var value = identity_default4, sortValues = descending_default, sort3 = null, startAngle = constant_default12(0), endAngle = constant_default12(tau5), padAngle = constant_default12(0);
  function pie(data) {
    var i, n = (data = array_default3(data)).length, j, k2, sum4 = 0, index4 = new Array(n), arcs = new Array(n), a0 = +startAngle.apply(this, arguments), da = Math.min(tau5, Math.max(-tau5, endAngle.apply(this, arguments) - a0)), a1, p = Math.min(Math.abs(da) / n, padAngle.apply(this, arguments)), pa = p * (da < 0 ? -1 : 1), v;
    for (i = 0; i < n; ++i) {
      if ((v = arcs[index4[i] = i] = +value(data[i], i, data)) > 0) {
        sum4 += v;
      }
    }
    if (sortValues != null)
    ...
    for (i = 0, k2 = sum4 ? (da - n * pa) / sum4 : 0; i < n; ++i, a0 = a1) {
      j = index4[i], v = arcs[j], a1 = a0 + (v > 0 ? v * k2 : 0) + pa, arcs[j] = {
        data: data[j],
        index: i,
        value: v,
        startAngle: a0,
...
function zoom_default3() {
  ...
  function mousedowned(event, ...args) {
    if (touchending || !filter6.apply(this, arguments))
      return;
    var currentTarget = event.currentTarget, g = gesture(this, args, true).event(event), v = select_default(event.view).on("mousemove.zoom", mousemoved, true).on("mouseup.zoom", mouseupped, true), p = pointer_default(event, currentTarget), x06 = event.clientX, y06 = event.clientY;
    nodrag_default(event.view);
  ...
  function dblclicked(event, ...args) {
    if (!filter6.apply(this, arguments))
      return;
    var t03 = this.__zoom, p02 = pointer_default(event.changedTouches ? event.changedTouches[0] : event, this), p1 = t03.invert(p02), k1 = t03.k * (event.shiftKey ? 0.5 : 2), t13 = constrain(translate(scale(t03, k1), p02, p1), extent3.apply(this, args), translateExtent);
    noevent_default3(event);
    if (duration > 0)
